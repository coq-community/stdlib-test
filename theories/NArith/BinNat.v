...
Proof.
  intros A A_wd A0 AS. apply peano_rect.
  - assumption.
  - intros; now apply -> AS.
Qed.
...
rewrite Pos.eqb_eq. split; intro H.
- now subst.
- now destr_eq H.
Qed.
...
Proof.
 ...
 destruct c as [ |r].
 - intros (s,H). destruct s; discriminate.
...
Proof.
 intros _. revert a m.
 induction n as [|n IHn] using peano_ind; intros a m.
 - now rewrite add_0_r.

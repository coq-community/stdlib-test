with builtins; with (import <nixpkgs> {}).lib;
{
  ...
  bundles = let
    ...
    // { fiat-crypto-legacy.override.version = "sp2019latest";
      ...
      metacoq-test.override.version = "proux01:stdlib_repo";
  ...
  in {
    "coq-master".coqPackages = common-bundles // {
      coq.override.version = "proux01:stdlib_repo_without_structure";
    };
